    ...
    <div class="content">
        <div class="content_top">
            <div class="content_top_left">
                ...
                <a class="report" href="javascript:;" @click="RiskClick" v-if="RiskEarlywarning" style="color: #F5605A">
                    危险预警报告
                </a>
            </div>
            <el-form class="search-bar" ref="form" :inline="true" :model="form">
                ...
                <el-form-item v-if="searchBtn">
                    <el-button type="primary" round @click="onSubmit"
                               style="background: #FE9834;width:90px;border:none;margin-right: 25px;">搜索
                    </el-button>
                </el-form-item>
            ...
            <el-table-column v-if="setting" :label="operation" width="600" align="center">
                <template slot-scope="scope">
                    <div style="display: inline-block;min-width: 100px;" v-if="operationLeft">
                        ...
                        <el-row>
                            <el-button v-if="check('测评报告')" @click="goTestReport(scope.row)" style="background: #F5605A;border:none!important;color: #fff;font-size: 16px">
                                测评报告
                            </el-button>
                            <el-button v-if="check('呼吸训练报告')" @click="BreathingDetail(scope.row)" style="border:none!important;background: #E83280;color: #fff;font-size: 16px">
                                呼吸训练报告
                            </el-button>
                            <el-button v-if="check('情绪调节报告')" @click="EmotionDetail(scope.row)" style="border:none!important;background: #A73AE6;color: #fff;font-size: 16px">
                                情绪调节报告
                            </el-button>
                            <el-button v-if="check('膳食营养报告')" @click="NutritionDetail(scope.row)" style="border:none!important;background: #04CECD;color: #fff;font-size: 16px">
                                膳食营养报告
                            </el-button>
                        </el-row>
                    </div>
...
export default {
    ...
    methods: {
        ...
        goTestReport(val) {
            ...
            // this.$router.replace({name: "TestReport",query:{patient_id:val.id,type:2}})
        },
        // 情绪调节报告按钮
        EmotionDetail(val) {
        ...
        // 呼吸训练报告按钮
        BreathingDetail(val) {
            this.$router.replace({name: "BreathingTraining",query:{patient_id:val.id,type:2}})
        },
        // 膳食营养报告按钮
        NutritionDetail(val) {
            this.$router.replace({name: "NutritionInfo",query:{patient_id:val.id,type:2}})
        }
    },
}
</script>
