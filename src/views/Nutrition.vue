<template>
    <div>
        ...
        <el-dialog custom-class="dialog"
                   ...
                   top="20vh"
        >
            <div slot="title" class="new-evaluationTitle">新建营养指导</div>
...
export default {
    ...
    methods: {
        ...
        async getPolicy() {
            ...
            this.papeList = []
            this.papeFormId = []
            await this.$axios.post('api/policy/dietary_lst',{
                type:1
            }).then(res => {
                if (res.data.code === 1) {
        ...
        async buttonSubmit() {
            ...
            this.papeForm.map(item => {
                test_paper_ids.push(item)
                console.log('test_paper_ids',item)
            })
