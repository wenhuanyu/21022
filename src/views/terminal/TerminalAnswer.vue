        ...
        <div class="sheet">
            ...
            <div style="width: 1450px;height: 600px;overflow-y: auto;">
                            ...
                            <div class="segment_list">
                                <div class="segment">
                                    ...
                                    <div v-for="(item,index) in topic.answer">
                                        ...
                                        <div v-html="item.title" class="line_text" v-if="item.checked == 0" style="color: #f5605a" @click="textClick(item,index)"></div>
                ...
                <div class="button-wrap">
                    <el-button class="prev-question" @click="readTopic">
                        <img src="../../assets/images/yuyin.png" alt="">
                        <span>重复语言</span>
                    </el-button>
                    <el-button class="prev-question" style="margin-left: 70px;" @click="prevTopic">
                        <img src="../../assets/images/prev.png" alt="">
                        <span>上一题</span>
                    </el-button>
                    <el-button class="next-question" @click="nextTopic">
                        <span>下一题</span>
                    ...
                    <!--                    </el-button>-->
                    <el-button class="submit-question" @click="endExam">
                        <span>结 束</span>
...
.prev-question, .next-question, .skip-question, .submit-question {
...
.skip-question {
    width: 220px;
    height: 70px;
    background: linear-gradient(0deg, #F39335 1%, #FCD79D 100%);
    box-shadow: 0px 6px 0px 0px #B56900;
    border-radius: 35px;
    margin-left: 72px;
