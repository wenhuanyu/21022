                    ...
                    <div>
                        <div class="print-row" v-if="showBar=printData[0].value"
                            ...
                            <div class="charts-wrap">
                                <div id="myChart_heart" :style="{width: '800px', height: '400px',margin:'40px'}"></div>
                            </div>
                        </div>
                        <div class="print-row" v-if="showBar=printData[0].value"
                             style="display: flex;justify-content: center;flex-direction:column;align-items: center;padding-left: 0;padding-right: 0;">
                            ...
                            <div class="charts-wrap">
                                <div id="myChart_heart1" :style="{width: '800px', height: '400px',margin:'40px'}"></div>
                            </div>
                        </div>
                        <div class="print-row" v-if="showBar=printData[0].value"
                             style="display: flex;justify-content: center;flex-direction:column;align-items: center;padding-left: 0;padding-right: 0;">
                            ...
                            <div class="charts-wrap">
                                <div id="myChart_heart2" :style="{width: '800px', height: '400px',margin:'40px'}"></div>
                            </div>
                        </div>
                    </div>
                    <div class="print-row" style="padding: 30px" v-if="showBar = printData[2].value">
                        <div class="print-row">
                            <div class="table-name">
                                ...
                                <div>
                                    <p class="no-print"><span class="edit-btn print-none" v-if="isShow" @click="getProposal({title:'结论',type:11,field:'conclusion'})"><i class="el-icon-edit"></i>点击此处修改</span></p>
                                </div>
                    ...
                    <div class="print-row" style="padding: 30px" v-if="showBar = printData[3].value">
                        <div class="print-row">
                            <div class="table-name">
                                ...
                                <div>
                                    <p class="no-print"><span class="edit-btn print-none" v-if="isShow" @click="getProposal({title:'医生建议',type:9,field:'doctor_proposal'})"><i class="el-icon-edit"></i>点击此处修改</span></p>
                                </div>
    ...
    methods:{
        ...
        drawLine(){
            ...
            for(var i =0;i<this.form.attention.length;i++) {
                ...
                lables.push(this.form.attention[i].program_name)
                ids.push(
                    {
                        a:this.form.attention[i].level,
                        b:this.form.attention[i].score
                    }
                )
                bbb.push({
                    a:this.form.attention[i].create_time,
                    b:this.form.attention[i].score
                })
            }
        ...
        drawLine1(){
            ...
            for(var i =0;i<this.form.meditation.length;i++) {
                ...
                lables.push(this.form.meditation[i].program_name)
                ids.push(
                    {
                        a:this.form.meditation[i].level,
                        b:this.form.meditation[i].score
                    }
                )
                bbb.push({
                    a:this.form.meditation[i].create_time,
                    b:this.form.meditation[i].score
                })
            }
        ...
        drawLine2(){
            ...
            for(var i =0;i<this.form.head_temp.length;i++) {
                ...
                lables.push(this.form.head_temp[i].program_name)
                ids.push(
                    {
                        a:this.form.head_temp[i].level,
                        b:this.form.head_temp[i].score
                    }
                )
                bbb.push({
                    a:this.form.head_temp[i].create_time,
                    b:this.form.head_temp[i].score
                })
            }
