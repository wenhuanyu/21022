                    ...
                    <div>
                        <div class="print-row" v-if="showBar=printData[0].value"
                            ...
                            <div class="charts-wrap">
                                <div id="myChart_heart" :style="{width: '900px', height: '400px',margin:'40px'}"></div>
                            </div>
                        </div>
                        <div class="print-row" v-if="showBar=printData[0].value"
                             style="display: flex;justify-content: center;flex-direction:column;align-items: center;padding-left: 0;padding-right: 0;">
                            ...
                            <div class="charts-wrap">
                                <div id="myChart_heart1" :style="{width: '900px', height: '400px',margin:'40px'}"></div>
                            </div>
                        </div>
                        <div class="print-row" v-if="showBar=printData[0].value"
                             style="display: flex;justify-content: center;flex-direction:column;align-items: center;padding-left: 0;padding-right: 0;">
                            ...
                            <div class="charts-wrap">
                                <div id="myChart_heart2" :style="{width: '900px', height: '400px',margin:'40px'}"></div>
                            </div>
                        </div>
                    </div>
