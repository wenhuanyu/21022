                ...
                <div class="print-body">
                    ...
                    <div class="print-row" style="padding: 30px" v-if="showBar=printData[1].value">
                        <div class="table-name">
                            ...
                            <div>
                                <p class="no-print"><span class="edit-btn"  v-show="isShow" @click="conclusion = true"><img src="../assets/images/bianzu.png"> 点击此处修改</span></p>
                            </div>
                        </div>
...
<!--                            <div v-if="item.status" style="font-weight: 400; width: 1000px;" v-for="(item,index) in form.conclusion.top"  :key="index" class=" flex text-left size-22 margin-5 no-margin-left no-margin-top no-margin-right">-->
<!--                                <div v-html="item.title"  style="font-weight: 400" class="margin-20 no-margin-left no-margin-top no-margin-bottom"></div>-->
<!--                                <div v-html="item.score" style="font-weight: 400; min-width: 100px; " class="margin-40 no-margin-left no-margin-top no-margin-bottom"></div>-->
<!--                                <div v-html="item.desc" style="font-weight: 400;color: #666666;"></div>-->
<!--                            </div>-->
<!--                        </div>-->
                        <div style="margin-top: 50px;">
                            <div v-if="item.status" v-for="(item,index) in form.conclusion.list"
                                 :key="index"
                                 class=" flex width-800 flex-justify-content-between text-left size-22 margin-5 no-margin-left no-margin-top no-margin-right">
                                <div style="font-weight: 400" v-html="item.title"></div>
                                <div  style="font-weight: 400" v-html="item.game_name" class="width-450"></div>
                    ...
                    <div class="print-row" style="padding: 30px" v-if="showBar = printData[2].value">
                        <div class="print-row">
                            <div class="table-name">
                                ...
                                <div>
                                    <p class="no-print"><span class="edit-btn" v-if="isShow" @click="getProposal({title:'医生建议',type:9,field:'doctor_proposal'})"><i class="el-icon-edit"></i>点击此处修改</span></p>
                                </div>
            ...
            <div style="width: 100%;">
                <div class="daying flex width-800 flex-justify-content-between flex-wrap">
                    <el-checkbox-group v-model="concl_top">
                        <el-checkbox v-for="(item,index) in form.conclusion.new_all" :key="index" :label="index">
