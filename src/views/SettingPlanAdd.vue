        ...
        <div class="content_top">
            ...
            <el-form class="search-bar">
                <el-button class="pink"
                           plain
                           @click="backPage"
                           icon="el-icon-arrow-left">返回系统页
                </el-button>
            </el-form>
        </div>
        <div class="content_body">
            <div class="top_edit">
                <p class="edit">添加测评方案</p>
            </div>
            <div class="row">
                <el-form ref="form"
                         :rules="rules"
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                ...
                level: [
                    {required: true, message: '请填写难易级别', trigger: 'blur'}
                ],
    ...
    mounted() {
        ...
        if (this.$route.query.id) {
            this.submitUrl = 'api/policy/edit2'
            this.onDetail();
        }
    },
    methods: {
        ...
        async onDetail() {
            await this.$axios.post('api/policy/info', this.$qs.stringify({id: this.id})).then(res => {
                if (res.data.code === 1) {
