                            ...
                            <div class="charts-16pf" ref="pf16" v-if="infoData && infoData.calc_name === '16PF'">
                                <table>
                                    ...
                                    <tr v-for="(socre, index) in infoData.extend.socre">
                                        ...
                                        <td align="center" style="color: #e20000"><strong>{{ socre }}</strong></td>
                            ...
                            <div class="print-row" :class="printData[3].value ? '' : 'print-none'" v-if="infoData.resting_period == 1">
                                ...
                                <div class="physical-signs-wrap">
                                    <div class="physical-signs" v-for="item in physiologyList">
                                        <div style="width: 30%"><span style="width: 180px;">{{ item.name }}</span> {{ item.score }}</div>
...
<!--                                <textarea ref="test_four"  style="height: 0;" class="report-text-content"  v-html="suggestion"></textarea>-->
                            ...
                            <div class="print-row" :class="printData[6].value ? '' : 'print-none'">
                                <div class="table-name">
                                    <p>孕周指导</p>
                                    <span class="edit-btn" v-if="showEdit"
                                          @click="getProposal({title:'孕周指导',type:3,field:'yunzhouzhidao'})"><i
                                        class="el-icon-edit"></i> 点击此处修改</span>
                                </div>
                            ...
                            <div class="print-row" :class="printData[7].value ? '' : 'print-none'">
                                <div class="table-name">
                                    <p>呼吸助产</p>
                                    <span class="edit-btn" v-if="showEdit"
                                          @click="getProposal({title:'呼吸助产',type:4,field:'huxizhuchan'})"><i
                                        class="el-icon-edit"></i> 点击此处修改</span>
                                </div>
<!--                                <textarea ref="test_two" class="report-text-content"  v-html="huxizhuchan" style="height: 0"></textarea>-->
                                <!--                        <div v-html="infoData.huxizhuchan" class="report-text-content"></div>-->
                                    <div v-html="huxizhuchan" class="report-text-content" style="font-weight: normal;white-space:pre-wrap;" contenteditable="true"></div>
                            </div>
                            <div class="print-row" :class="printData[8].value ? '' : 'print-none'">
                                <div class="table-name">
                                    <p>医生建议</p>
                                    <span class="edit-btn" v-if="showEdit"
...
<!--                                <textarea ref="test_one"  class="report-text-content"  v-html="doctor_proposal" style="height: 0"></textarea>-->
                        ...
                        <template v-else-if="infoData.calc_name === 'MMPICT'">
                            ...
                            <div class="MMPICT print-row" :class="printData_[9].value ? '' : 'print-none'">
                                ...
                                <div class="MMPICT-ii" style="width: 100%; margin: 0 auto;">
                                    <div style="padding-right: 2px" class="table-one">
                                        <el-table
                                            border
    ...
    data() {
        return {
            ...
            printData: [
                ...
                {id: '7', name: '孕周指导', value: false},
                {id: '8', name: '呼吸助产', value: false},
                {id: '9', name: '医生建议', value: false},
            ],
            printData_: [
                {id: '1', name: '是否打印图片', value: false},
                {id: '2', name: '患者详细数据打印', value: false},
        ...
        async getInfo() {
            await this.$axios.post('api/exam/report', this.$qs.stringify(this.detailForm)).then(res => {
                if (res.data.code === 1) {
                    ...
                    this.huxizhuchan = this.infoData.huxizhuchan
