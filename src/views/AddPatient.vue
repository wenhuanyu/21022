    ...
    <div id="AddPatient" class="content">
        <div class="box">
                ...
                <div class="form" v-show="pageIndex==1" style="display: flex ">
                    ...
                    <div style="width: 50%">
                        ...
                        <el-form-item label="婚姻状态" prop="marriage_id" >
                            <el-select v-model="formData.marriage_id" placeholder="请选择" style="width: 100%;" @change="marriageChange($event)">
                                <el-option v-for="item in maritalStatusArr" :key="item.id" :label="item.name"
                                           :value="item.id"></el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="学历信息" prop="education_id">
                            <el-select v-model="formData.education_id" placeholder="请选择" style="width: 100%;" @change="educationChange($event)">
                                <el-option v-for="item in educationInformationArr" :key="item.id" :label="item.name"
                                           :value="item.id"></el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="职业信息" prop="occupation_id">
                            <el-select v-model="formData.occupation_id" placeholder="请选择" style="width: 100%;" @change="occupationChange($event)">
                ...
                <div class="form" v-show="pageIndex==2">
                    ...
                    <div class="form-box">
                        <el-form label-width="160px">
                            ...
                            <el-form-item label="初次妊娠时间">
                                <el-date-picker type="date" placeholder="选择日期" style="width:100%"
                                                v-model="formData.first_time"
                                                value-format="yyyy-MM-dd"></el-date-picker>
                            </el-form-item>
                            <el-form-item label="孕周">
                                <el-input v-model="formData.yunzhou"></el-input>
                            </el-form-item>
            ...
            <div class="margin-top box-nowrap footer">
                ...
                <el-button type="primary" round @click="pageChange('prev')" v-if="page_One" style="border: none!important;">上一页</el-button>
                <el-button type="primary" round @click="pageChange('next')" v-if="page_two" style="border: none!important;">下一页</el-button>
