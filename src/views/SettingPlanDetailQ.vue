...
<!--                            </el-option>-->
<!--                        </el-select>-->
<!--                        <span style="color: #666666 ; margin-right: 10px; margin-left: 5px;">皮温</span>-->
...
<!--                            </el-option>-->
<!--                        </el-select>-->
<!--                        <span style="color: #666666 ; margin-right: 10px; margin-left: 5px;">注意力/放松度</span>-->
        ...
        async onDetail() {
            await this.$axios.post('api/emotion_policy/info', this.$qs.stringify({id: this.id})).then(res => {
                if (res.data.code === 1) {
                    ...
                    // this.value_ids = data.game_ids.split(',').map(id => {
                    //     return +id;
                    // })
                    let listMap = {}
                    let timeMap = {}
