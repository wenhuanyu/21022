            ...
            <div class="print_html" ref="print" id="print">
                ...
                <div class="print-body">
                    ...
                    <div class="print-row1"  style="">
                        <div class="table_title" style="font-size: 28px; font-weight:bold; color:#000; display: flex;justify-content: center;flex-direction:column; align-items: center;">测评时间</div>
                        <div class="first1">
                        <div class="first-group">
                            <div class="row">
                                <span>测评时间</span>
